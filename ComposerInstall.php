...
"
        ...
        $fichierConfig[23] = '    private $configRecoveryRetry = ' . $recoveryRetry . ';' . "\r\n";
        $fichierConfig[24] = '    private $configSeed = "' . $seed . '";' . "\r\n";
    ...
    public function travisConfig()
    {
        ...
        $fichierConfig[25] = '    private $configSeed = "54987-90400-93605-34136-24507-68510";' . "\r\n";
        $fichierConfig[26] = '    private $configMaxTry = 5;' . "\r\n";
