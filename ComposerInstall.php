...
"
        ...
        $fichierConfig[18] = '	private $_configSqlDb = "' . $db . '";' . "\r\n";
        $fichierConfig[21] = '	private $_configSessionExpire = ' . $sessionExpire . ';' . "\r\n";
        $fichierConfig[22] = '	private $_configRecoveryExpire = ' . $recoveryExpire . ';' . "\r\n";
        $fichierConfig[23] = '	private $_configSeed = "' . $seed . '";' . "\r\n";
